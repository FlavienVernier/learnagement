 ...
 */
export default function ListFilieresAsAnonymous({filieres} : {filieres: FiliereAsAnonymous[]}){
    ...
    function filiereClicked(str: string){
        let filiere:FiliereAsAnonymous|undefined = filieres.find(
            (element: FiliereAsAnonymous): boolean => str == element.nom_filiere
        )
        ...
        if(filiere != undefined){
            ...
            setIdFiliereClicked([filiere.id_filiere])
        }
    }
    ...
    return (
        <>
            ...
            {nomFiliereClicked.length > 0 && idFiliereClicked.length > 0 &&(
                <ModaleFiliere
                    idFiliere={idFiliereClicked}
                    setIdFiliere={setIdFiliereClicked}
