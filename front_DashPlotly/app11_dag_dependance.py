...
def compute_graph(token, id_module):
...
def register_callbacks(app):
    ...
    def update_graph(id_module, token):
        ...
        node_x, node_y, node_text, node_color_values, node_hovertext, node_text, dark_node_color_values, edge_trace, annotations = compute_graph(token, id_module)
