...
(9501, 11, 8, 2, '2026-04-02 09:00:00'),
(9501,  3, 8, 3, '2026-04-02 09:00:00'),
(9501, 13, 8, 4, '2026-04-02 09:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9502,  1, 8, 1, '2026-04-03 10:00:00'),
(9502, 34, 8, 2, '2026-04-03 10:00:00'),
(9502, 11, 8, 3, '2026-04-03 10:00:00'),
(9502,  3, 8, 4, '2026-04-03 10:00:00'),
(9502, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-03 10:00:00');

-- Lea Bernard (9503, note=13) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9503,  1, 8, 1, '2026-04-01 14:00:00'),
(9503, 11, 8, 2, '2026-04-01 14:00:00'),
(9503,  3, 8, 3, '2026-04-01 14:00:00'),
(9503, 45, 8, 4, '2026-04-01 14:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9504,  1, 8, 1, '2026-04-04 11:00:00'),
(9504, 45, 8, 2, '2026-04-04 11:00:00'),
(9504, 13, 8, 3, '2026-04-04 11:00:00'),
(9504, 34, 8, 4, '2026-04-04 11:00:00'),
(9504, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-04 11:00:00');
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9511,  8, 8, 1, '2026-04-01 09:30:00'),
(9511, 10, 8, 2, '2026-04-01 09:30:00'),
(9511,  9, 8, 3, '2026-04-01 09:30:00'),
(9511,  1, 8, 4, '2026-04-01 09:30:00'),
(9511, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-01 09:30:00');

-- Julie Garcia (9512, note=15) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9512,  8, 8, 1, '2026-04-02 10:00:00'),
(9512, 10, 8, 2, '2026-04-02 10:00:00'),
(9512,  9, 8, 3, '2026-04-02 10:00:00'),
(9512,  1, 8, 4, '2026-04-02 10:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9513,  8, 8, 1, '2026-04-05 15:00:00'),
(9513, 10, 8, 2, '2026-04-05 15:00:00'),
(9513,  9, 8, 3, '2026-04-05 15:00:00'),
(9513,  1, 8, 4, '2026-04-05 15:00:00'),
(9513, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-05 15:00:00');
...
(9521, 45, 8, 2, '2026-04-02 10:00:00'),
(9521, 68, 8, 3, '2026-04-02 10:00:00'),
(9521, 30, 8, 4, '2026-04-02 10:00:00'),
(9521, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-02 10:00:00');

-- Nathan Thomas (9522, note=14) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9522, 45, 8, 1, '2026-04-04 14:00:00'),
(9522, 11, 8, 2, '2026-04-04 14:00:00'),
(9522, 68, 8, 3, '2026-04-04 14:00:00'),
(9522, 30, 8, 4, '2026-04-04 14:00:00'),
(9522, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-04 14:00:00');

-- Ines Robert (9523, note=11) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9523, 68, 8, 1, '2026-04-06 16:00:00'),
(9523, 45, 8, 2, '2026-04-06 16:00:00'),
(9523, 11, 8, 3, '2026-04-06 16:00:00'),
(9523, 30, 8, 4, '2026-04-06 16:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9531, 35, 8, 1, '2026-04-01 11:00:00'),
(9531, 37, 8, 2, '2026-04-01 11:00:00'),
(9531, 12, 8, 3, '2026-04-01 11:00:00'),
(9531, 78, 8, 4, '2026-04-01 11:00:00'),
(9531, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-01 11:00:00');

-- Florian Leroy (9532, note=14) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9532, 37, 8, 1, '2026-04-03 13:00:00'),
(9532, 35, 8, 2, '2026-04-03 13:00:00'),
(9532, 12, 8, 3, '2026-04-03 13:00:00'),
(9532, 78, 8, 4, '2026-04-03 13:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9533, 12, 8, 1, '2026-04-05 09:00:00'),
(9533, 35, 8, 2, '2026-04-05 09:00:00'),
(9533, 37, 8, 3, '2026-04-05 09:00:00'),
(9533, 78, 8, 4, '2026-04-05 09:00:00'),
(9533, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-05 09:00:00');
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9541, 22, 8, 1, '2026-04-02 09:00:00'),
(9541, 50, 8, 2, '2026-04-02 09:00:00'),
(9541, 26, 8, 3, '2026-04-02 09:00:00'),
(9541, 43, 8, 4, '2026-04-02 09:00:00'),
(9541, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-02 09:00:00');

-- Remy Leroux (9542, note=14) — 5 voeux soumis
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9542, 50, 8, 1, '2026-04-04 11:00:00'),
(9542, 22, 8, 2, '2026-04-04 11:00:00'),
(9542, 43, 8, 3, '2026-04-04 11:00:00'),
(9542, 26, 8, 4, '2026-04-04 11:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9543, 43, 8, 1, '2026-04-06 15:00:00'),
(9543, 50, 8, 2, '2026-04-06 15:00:00'),
(9543, 22, 8, 3, '2026-04-06 15:00:00'),
(9543, 26, 8, 4, '2026-04-06 15:00:00'),
(9543, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-06 15:00:00');
...
(9551, 32, 8, 2, '2026-04-01 10:00:00'),
(9551, 54, 8, 3, '2026-04-01 10:00:00'),
(9551, 46, 8, 4, '2026-04-01 10:00:00'),
...
INSERT INTO MOB_wishes (id_etudiant, id_partner_university, id_semestre, priority, submission_date) VALUES
(9552, 32, 8, 1, '2026-04-03 14:00:00'),
(9552, 85, 8, 2, '2026-04-03 14:00:00'),
(9552, 54, 8, 3, '2026-04-03 14:00:00'),
(9552, 46, 8, 4, '2026-04-03 14:00:00'),
(9552, (SELECT id_partner_university FROM MOB_partner_university WHERE code = 'MOB_STAGE'), 8, 5, '2026-04-03 14:00:00');
