...
CREATE TABLE `APC_competence_as_filiere_as_statut` (
  ...
  PRIMARY KEY (`id_competence`,`id_filiere`,`id_status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `CLASS_absence` (
  ...
  PRIMARY KEY (`id_seance_to_be_affected_as_enseignant`,`id_etudiant`),
  UNIQUE KEY `SECONDARY` (`id_seance_to_be_affected_as_enseignant`,`id_etudiant`) USING BTREE,
  ...
  CONSTRAINT `FK_absence_as_session_to_be_affected_as_enseignant` FOREIGN KEY (`id_seance_to_be_affected_as_enseignant`) REFERENCES `CLASS_session_to_be_affected_as_enseignant` (`id_seance_to_be_affected_as_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `CLASS_session_to_be_affected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CLASS_session_to_be_affected` (
  `id_seance_to_be_affected` int NOT NULL AUTO_INCREMENT,
  `id_module_sequence` int DEFAULT NULL,
  `id_groupe` int NOT NULL,
  PRIMARY KEY (`id_seance_to_be_affected`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `CLASS_session_to_be_affected_as_enseignant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CLASS_session_to_be_affected_as_enseignant` (
  `id_seance_to_be_affected_as_enseignant` int NOT NULL AUTO_INCREMENT,
  `id_seance_to_be_affected` int NOT NULL,
  `id_enseignant` int DEFAULT NULL,
  `schedule` datetime DEFAULT NULL,
  `id_responsable` int NOT NULL,
  `modifiable` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_seance_to_be_affected_as_enseignant`),
  UNIQUE KEY `SECONDARY` (`id_seance_to_be_affected`) USING BTREE,
  KEY `FK_seance_to_be_affected_as_enseignant_as_enseignant` (`id_enseignant`),
  KEY `FK_seance_to_be_affected_as_enseignant_as_responsable` (`id_responsable`),
  CONSTRAINT `FK_seance_to_be_affected_as_enseignant_as_enseignant` FOREIGN KEY (`id_enseignant`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_seance_to_be_affected_as_enseignant_as_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_seance_to_be_affected_as_enseignant_as_seance_to_be_affected` FOREIGN KEY (`id_seance_to_be_affected`) REFERENCES `CLASS_session_to_be_affected` (`id_seance_to_be_affected`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1658 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `CLASS_session_type_to_be_affected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CLASS_session_type_to_be_affected` (
  `id_type_seance_to_be_affected` int NOT NULL AUTO_INCREMENT,
  `id_module_sequencage` int NOT NULL,
  `id_groupe` int NOT NULL,
  PRIMARY KEY (`id_type_seance_to_be_affected`),
  UNIQUE KEY `SECONDARY` (`id_module_sequencage`,`id_groupe`) USING BTREE,
  KEY `FK_type_seance_to_be_affected_as_groupe` (`id_groupe`),
  CONSTRAINT `FK_type_seance_to_be_affected_as_groupe` FOREIGN KEY (`id_groupe`) REFERENCES `LNM_groupe` (`id_groupe`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_type_seance_to_be_affected_as_module_sequence` FOREIGN KEY (`id_module_sequencage`) REFERENCES `MAQUETTE_module_sequencage` (`id_module_sequencage`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `CLASS_session_type_to_be_affected_as_enseignant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CLASS_session_type_to_be_affected_as_enseignant` (
  `id_type_seance_to_be_affected_as_enseignant` int NOT NULL AUTO_INCREMENT,
  `id_type_seance_to_be_affected` int NOT NULL,
  `id_enseignant` int DEFAULT NULL,
  `id_responsable` int NOT NULL,
  `modifiable` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_type_seance_to_be_affected_as_enseignant`),
  UNIQUE KEY `SECONDARY` (`id_type_seance_to_be_affected`) USING BTREE,
  KEY `FK_type_seance_to_be_affected_as_enseignant_as_enseignant` (`id_enseignant`),
  KEY `FK_type_seance_to_be_affected_as_enseignant_as_responsable` (`id_responsable`),
  CONSTRAINT `FK_tseance_to_be_affected_as_enseignant_as_seance_to_be_affected` FOREIGN KEY (`id_type_seance_to_be_affected`) REFERENCES `CLASS_session_type_to_be_affected` (`id_type_seance_to_be_affected`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `FK_type_seance_to_be_affected_as_enseignant_as_enseignant` FOREIGN KEY (`id_enseignant`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_type_seance_to_be_affected_as_enseignant_as_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `EXT_seance_planned` (
  ...
  UNIQUE KEY `date` (`date`,`id_enseignant`),
  KEY `FK_seance_seanceType` (`type`),
  CONSTRAINT `FK_seance_seanceType` FOREIGN KEY (`type`) REFERENCES `LNM_seanceType` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data extracted from calendar system';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `INFO_etat_module`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `INFO_etat_module` (
  `id_etat_module` int NOT NULL AUTO_INCREMENT,
  `etat` varchar(11) NOT NULL,
  `commentaire` text,
  `id_responsable` int DEFAULT NULL,
  PRIMARY KEY (`id_etat_module`),
  UNIQUE KEY `SECONDARY` (`etat`),
  KEY `FK_etat_module_as_responsable` (`id_responsable`),
  CONSTRAINT `FK_etat_module_as_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `LNM_entreprise`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `LNM_entreprise` (
...
CREATE TABLE `MAQUETTE_dependance_sequence` (
  ...
  KEY `FK_dependance_sequence_as_enseignant` (`id_responsable`),
  CONSTRAINT `FK_dependance_sequence_as_enseignant` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `MAQUETTE_module` (
  ...
  KEY `FK_module_as_etat_module` (`id_etat_module`),
  ...
  CONSTRAINT `FK_module_as_etat_module` FOREIGN KEY (`id_etat_module`) REFERENCES `INFO_etat_module` (`id_etat_module`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `MAQUETTE_module_as_learning_unit` (
  ...
  KEY `FK_module_sequencage_as_responsable` (`id_responsable`),
  ...
  CONSTRAINT `FK_module_sequencage_as_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MAQUETTE_module_sequencage` (
  ...
  KEY `FK_module_sequencage_as_enseignant` (`id_responsable`),
  ...
  CONSTRAINT `FK_module_sequencage_as_enseignant` FOREIGN KEY (`id_responsable`) REFERENCES `LNM_enseignant` (`id_enseignant`) ON DELETE RESTRICT ON UPDATE RESTRICT,
