...
from api.route_factory import register_auto_routes
...
from repositories.LNM_filiere_requests import requests, __requests
...
register_auto_routes(router, __requests)
